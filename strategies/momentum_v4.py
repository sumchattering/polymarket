"""
Momentum V4 — RSI(21) 35/65 + ADX/CHOP trending filter.

Change from V3: RSI period 14→21, thresholds 30/70→35/65.
Longer lookback = more selective = higher accuracy at same trade volume.

Backtested 30 days (Feb 16 - Mar 18, 2026):
  DOGE: 56.5% WR, ~57 trades/day
  XRP:  55.0% WR, ~59 trades/day
